...
public class MAC_belaz {
    ...
    public MAC_belaz(int size, int[][] b) {
        this.size = size;
        ...
        pq = new PriorityQueue<Variable>(new Comparator<Variable>() {
            public int compare(Variable lhs, Variable rhs) {
                ...
                if (lhs.domain.size() == rhs.domain.size()){
                    if (lhs.max_forward_degree > rhs.max_forward_degree)
                        return -1;
                    else if (lhs.max_forward_degree < rhs.max_forward_degree)
                        return +1;
                    return 0;
                }
    ...
    void addDegree(int row,int col){
        for (int i = 0; i < size; i++) {
